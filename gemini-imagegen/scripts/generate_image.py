...
Usage:
    ./generate_image.py "prompt" output.jpg [--model MODEL] [--aspect RATIO] [--size SIZE]

Examples:
    ./generate_image.py "A cat in space" cat.jpg
    ./generate_image.py "A logo for Acme Corp" logo.jpg --model gemini-3-pro-image-preview --aspect 1:1
    ./generate_image.py "Epic landscape" landscape.jpg --aspect 16:9 --size 2K
