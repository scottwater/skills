...
Usage:
    ./edit_image.py input.jpg "edit instruction" output.jpg [options]

Examples:
    ./edit_image.py photo.jpg "Add a rainbow in the sky" edited.jpg
    ./edit_image.py room.jpg "Change the sofa to red leather" room_edited.jpg
    ./edit_image.py portrait.jpg "Make it look like a Van Gogh painting" artistic.jpg --model gemini-3-pro-image-preview
